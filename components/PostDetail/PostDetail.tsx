...
export const PostDetail: React.FC<PostDetailProps> = () => {
  ...
  const topImageUrl =
    topImage && topImage.url ? topImage.url : DEFAULT_POST_IMAGE_LINK;
  ...
  return (
    <div className="flex flex-col items-center space-y-2 bg-gray-100 h-full px-2">
      ...
      <div className="text-base text-gray-900 font-thin">
      ...
      <div className="w-full">
        <button
          className="w-full px-3 py-2 rounded-md border-2 border-green-600"
          onClick={() => {}}
        >
          レンタルする
        </button>
